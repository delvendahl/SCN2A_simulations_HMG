...
:
: modified Jan 2019 by Igor Delvendahl
:
...
NEURON {
    ...
    GLOBAL vShift_act, vShift_inact, maxrate, ah_scale, bh_scale, a_scale, b_scale
...
:   gbar = 33     (millimho/cm2)
    ...
    vShift_act = 10            (mV)  	: shift to the right to account for Donnan potentials
	...
	a_scale = 1						: scaling factor for activation
	b_scale = 1						: scaling factor for activation
	...
	q10h  = 3.0						: temperature sensitivity for inactivation
